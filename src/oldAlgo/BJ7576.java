...
// public class src.oldAlgo.BJ7576 {
//     static int N;
//     static int M;
...
// class src.oldAlgo.Tomato { // 여기서 왜 클래스를 따로 선언해주는 걸까 Tomato를 여러개 쓴다 이말이지
// int x, y, day;

// src.oldAlgo.Tomato(int x, int y, int day) {
// this.x = x;
// this.y = y;
// this.day = day;
// }
...
// Queue<src.oldAlgo.Tomato> q = new LinkedList<src.oldAlgo.Tomato>(); // Tomato형 큐 선언

// for (int i = 0; i < n; i++) {
// for (int j = 0; j < m; j++) {
// if (garden[i][j] == 1) { // 정원에 꽃이 있다면
// q.offer(new src.oldAlgo.Tomato(i, j, 0)); // Tomato를 큐에 넣는다 day0이네
// }
// }
// }

// while (!q.isEmpty()) {
// src.oldAlgo.Tomato tomato = q.peek(); // 큐의 가장 앞에 있는 값을 Tomato형 x,y,day를 저장한다
...
// q.offer(new src.oldAlgo.Tomato(nextX, nextY, nextDay)); // 좌표바뀐거랑 날짜를 큐에 저장
// }
// }
// }
...
// public static void main(String[] args) {
// src.oldAlgo.BJ7576 sol = new src.oldAlgo.BJ7576();
